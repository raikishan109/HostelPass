...
const StudentDashboard = () => {
  ...
  return (
    <StudentLayout 
      title="Dashboard" 
      subtitle={`Welcome back, ${userData?.name?.split(' ')[0] || 'Student'}! 👋`}
    >
      {/* Search Hero */}
      <div className="dashboard-hero" style={{ background: 'white', borderRadius: '20px', padding: '32px', marginBottom: '28px', position: 'relative', overflow: 'hidden', border: '1px solid #eee', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
        ...
        <div className="hero-search-wrapper" style={{ display: 'flex', gap: '10px' }}>
      ...
      {/* Stats */}
      <div className="grid-4 stats-grid" style={{ marginBottom: '28px' }}>
        {stats.map((s, i) => (
