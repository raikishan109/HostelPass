  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="main-content">
        <Topbar title="Platform Analytics" subtitle="Overview of the entire Hostel-Pass platform" />
        <div className="page-content animate-fadeIn">
          <div className="grid-4" style={{ marginBottom: '28px' }}>
            {[
              { icon: <MdApartment />, label: 'Total PG Listings', value: MOCK_PGS.length, color: 'red' },
              { icon: <MdVerified />, label: 'Verified PGs', value: verifiedCount, color: 'green' },
              { icon: <MdStar />, label: 'Platform Avg Rating', value: avgRating, color: 'amber' },
              { icon: <MdRestaurant />, label: 'Platform Avg Mess', value: avgMess, color: 'red' },
            ].map((s, i) => (
