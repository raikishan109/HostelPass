  ...
  return (
    <div className="pwa-install-banner" style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div>
          <div style={{ fontWeight: 800, fontSize: '14px', color: '#1a1a1a', lineHeight: 1.2 }}>HostelPass Admin</div>
          <div style={{ fontSize: '11px', color: '#777', marginTop: '2px' }}>Monitor system status</div>
        </div>
      </div>
