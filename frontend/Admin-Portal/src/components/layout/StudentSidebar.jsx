  ...
  return (
    <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
      <nav className="sidebar-nav">
        ...
        <Link to="/student/search" className={`sidebar-link ${isActive('/student/search') ? 'active' : ''}`}>
          <MdSearch /> Find PGs
        </Link>
        <Link to="/student/favorites" className={`sidebar-link ${isActive('/student/favorites') ? 'active' : ''}`}>
          <MdFavorite /> Saved PGs
        </Link>

        <div className="sidebar-section-title">Activity</div>
        <Link to="/student/reviews" className={`sidebar-link ${isActive('/student/reviews') ? 'active' : ''}`}>
          <MdRateReview /> My Reviews
        </Link>
        <Link to="/student/complaints" className={`sidebar-link ${isActive('/student/complaints') ? 'active' : ''}`}>
          <MdReport /> Complaints
        </Link>
