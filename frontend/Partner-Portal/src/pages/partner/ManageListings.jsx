  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="main-content">
        <Topbar title="My Listings" subtitle={`${pgs.length} active listings`} />
        <div className="page-content animate-fadeIn">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {pgs.map(pg => (
              <div key={pg.id} style={{ background: 'white', borderRadius: '16px', border: '1px solid var(--border)', padding: '20px', display: 'flex', alignItems: 'center', gap: '20px' }}>
