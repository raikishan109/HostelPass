      ...
      <div className="nav-left">
        ...
        <Link to="/partner" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
            <span className="logo-text" style={{ color: 'var(--text-dark)', fontSize: '20px' }}>
              Hostel<span style={{ color: '#00796b' }}>Pass</span>
            </span>
            <span style={{ fontSize: '10px', fontWeight: 700, color: '#00796b', textTransform: 'uppercase', letterSpacing: '1px', marginTop: '2px' }}>
              Partner Portal
            </span>
          </div>
        </Link>
